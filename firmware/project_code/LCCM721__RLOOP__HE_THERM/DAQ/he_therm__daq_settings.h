/**
 * @file		HE_THERM__DAQ_SETTINGS.H
 * @brief		DAQ settings for HE Thermal
 * @author		Lachlan Grogan
 * @st_fileID	LCCM721R0.FILE.009
 */
...
#ifndef _HETHERM__DAQ_SETTINGS_H_
#define _HETHERM__DAQ_SETTINGS_H_
...
#endif /* _HETHERM__DAQ_SETTINGS_H_ */
