...
#Region "MEMBERS"
        ...
        Private m_txtBQ76_Cell(C_NUM_CELLS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_F32
        ...
        Private m_btnDischge(C_NUM_CELLS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
...
#Region "PANEL LAYOUT"
        ...
        Public Overrides Sub LayoutPanel()
            ...
            Dim l3(18 - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            For iCounter As Integer = 0 To 18 - 1
                l3(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(iCounter.ToString & ": V")
                If iCounter = 0 Then
                    l3(iCounter).Layout__BelowControl(Me.m_txtBQ76_FaultFlags(0))
                ElseIf iCounter = 6 Then
                    l3(iCounter).Layout__BelowControl(Me.m_btnDischge(0))
                ElseIf iCounter = 12 Then
                    l3(iCounter).Layout__BelowControl(Me.m_btnDischge(6))
                Else
                    l3(iCounter).Layout__AboveRightControl(l3(iCounter - 1), Me.m_txtBQ76_Cell(iCounter - 1))
                End If
                Me.m_txtBQ76_Cell(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_F32(100, l3(iCounter))

                Me.m_btnDischge(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Resistor On", AddressOf Me.btnDischg_Click)
                Me.m_btnDischge(iCounter).Tag = iCounter.ToString
                Me.m_btnDischge(iCounter).Layout__BelowControl(Me.m_txtBQ76_Cell(iCounter))

            Next

            Dim l6 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Pack Volts", Me.m_btnDischge(12))
            ...
            If MyBase.m_bLayout = True Then
                ...
                If ePacketType = SIL3.rLoop.rPodControl.Ethernet.E_NET__PACKET_T.NET_PKT__PWR_BMS__TX_BMS_STATUS Then
                    ...
                    For iCounter As Integer = 0 To C_NUM_CELLS - 1
                        iOffset += Me.m_txtBQ76_Cell(iCounter).Value__Update(u8Payload, iOffset)
                    Next
