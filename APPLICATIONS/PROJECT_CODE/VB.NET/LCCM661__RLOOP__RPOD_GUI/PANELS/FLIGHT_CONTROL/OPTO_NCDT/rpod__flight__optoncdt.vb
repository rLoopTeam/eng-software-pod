...
#Region "MEMBERS"
        ...
        Private m_txtModuleFlags As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_FaultFlags

        Private m_txtLaser_Flags() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_FaultFlags
        Private m_txtLaser_ErrorCount() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtLaser_Byte1Count() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtLaser_LaserRaw() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtLaser_LaserFiltered() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtLaser_SuccessCount() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtCalValue As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        ...
        Public Sub InernalEvent__UDPSafe__RxPacketB(ByVal ePacketType As SIL3.rLoop.rPodControl.Ethernet.E_NET__PACKET_T, ByVal u16PayloadLength As LAPP188__RLOOP__LIB.SIL3.Numerical.U16, ByRef u8Payload() As Byte, ByVal u16CRC As LAPP188__RLOOP__LIB.SIL3.Numerical.U16)
            ...
            If MyBase.m_bLayout = True Then
                ...
                If ePacketType = SIL3.rLoop.rPodControl.Ethernet.E_NET__PACKET_T.NET_PKT__LASER_OPTO__TX_LASER_DATA Then
                    ...
                    Dim pU32Module As New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pU32ModuleSpare As New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                    iOffset += 4

                    Dim pU32_LaserFlags(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.U32
                    Dim pU32_LaserErrorCount(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.U32
                    Dim pU32_LaserByte1(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.U32
                    Dim pF32_LaserRaw(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.F32
                    Dim pF32_LaserFiltered(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.F32
                    Dim pU32_LaserSpare(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.Numerical.U32

                    For iCounter As Integer = 0 To C_NUM_LASERS - 1
                        pU32_LaserFlags(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                        iOffset += 4
                        pU32_LaserErrorCount(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                        iOffset += 4
                        pU32_LaserByte1(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                        iOffset += 4
                        pF32_LaserRaw(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.F32(u8Payload, iOffset)
                        iOffset += 4
                        pF32_LaserFiltered(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.F32(u8Payload, iOffset)
                        iOffset += 4
                        pU32_LaserSpare(iCounter) = New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                        iOffset += 4
                    Next
...
#Region "PANEL LAYOUT"
        ...
        Public Overrides Sub LayoutPanel()
            ...
            Dim la0(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim la1(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim la2(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim la3(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim la4(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim la5(C_NUM_LASERS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper

            For iCounter As Integer = 0 To C_NUM_LASERS - 1


                If iCounter = 0 Then
                    la0(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Laser Flags", Me.m_txtModuleFlags)
                Else
                    la0(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Laser Flags", Me.m_txtLaser_Flags(iCounter - 1))
                End If

                la1(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Error Count")
                la2(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Byte1 Errors")
                la3(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Laser Raw")
                la4(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Laser Filtered")
                ...
                Me.m_txtLaser_Byte1Count(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, la2(iCounter))
                la3(iCounter).Layout__AboveRightControl(la0(iCounter), Me.m_txtLaser_Byte1Count(iCounter))
                Me.m_txtLaser_LaserRaw(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, la3(iCounter))
                la4(iCounter).Layout__AboveRightControl(la0(iCounter), Me.m_txtLaser_LaserRaw(iCounter))
                Me.m_txtLaser_LaserFiltered(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, la4(iCounter))
                la5(iCounter).Layout__AboveRightControl(la0(iCounter), Me.m_txtLaser_LaserFiltered(iCounter))
                Me.m_txtLaser_SuccessCount(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, la5(iCounter))
            ...
            Dim l22 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Calibration Value")
            l22.Layout__BelowControl(btnOn)
            Me.m_txtCalValue = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, l22)
            Me.m_txtCalValue.Threadsafe__SetText("0.0")

            Dim btnCal As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Calibrate", AddressOf btnCal__Click)
...
#Region "BUTTON HELPERS"
        ...
        Private Sub btnCal__Click(s As Object, e As EventArgs)
            ...
            Dim pf32 As New LAPP188__RLOOP__LIB.SIL3.Numerical.F32(Single.Parse(Me.m_txtCalValue.Text))
