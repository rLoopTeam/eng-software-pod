...
#Region "MEMBERS"
        ...
        Private m_txtMotor_MicroSteps() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtMotor_MaxAngularAccel() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtMotor_MicronsRev() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtMotor_MaxRPM() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtMotor_TimerPeriod() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        Private m_txtMotor_UpdateFreq() As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper
        ...
        Public Sub InernalEvent__UDPSafe__RxPacketB(ByVal ePacketType As SIL3.rLoop.rPodControl.Ethernet.E_NET__PACKET_T, ByVal u16PayloadLength As LAPP188__RLOOP__LIB.SIL3.Numerical.U16, ByRef u8Payload() As Byte, ByVal u16CRC As LAPP188__RLOOP__LIB.SIL3.Numerical.U16)
            ...
            If MyBase.m_bLayout = True Then
                ...
                If ePacketType = SIL3.rLoop.rPodControl.Ethernet.E_NET__PACKET_T.NET_PKT__FCU_BRAKES__TX_MOTOR_PARAM Then
                    ...
                    Dim pU32L_MicrostepRes As New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32L_MaxAngularAccel As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32L_MicronsRev As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32L_StepsRev As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32L_MaxAngularVeloc As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4

                    Dim pU32R_MicrostepRes As New LAPP188__RLOOP__LIB.SIL3.Numerical.U32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32R_MaxAngularAccel As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32R_MicronsRev As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32R_StepsRev As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4
                    Dim pS32R_MaxAngularVeloc As New LAPP188__RLOOP__LIB.SIL3.Numerical.S32(u8Payload, iOffset)
                    iOffset += 4

                    Dim u8RTI_Timer As New LAPP188__RLOOP__LIB.SIL3.Numerical.U8(u8Payload, iOffset)
                    iOffset += 1
...
#Region "PANEL LAYOUT"
        ...
        Public Overrides Sub LayoutPanel()
            ...
            Dim l0(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim l1(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim l2(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim l3(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim l4(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper
            Dim l5(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper

            Dim btnUpdate(C_NUM_MOTORS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
            ...
            For iCounter As Integer = 0 To C_NUM_MOTORS - 1
                ...
                If iCounter = 0 Then
                    l0(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(10, 10, sAxis & " Microsteps", MyBase.m_pInnerPanel)
                Else
                    l0(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " Microsteps")
                    l0(iCounter).Layout__BelowControl(Me.m_txtMotor_MicroSteps(iCounter - 1))
                End If

                Me.m_txtMotor_MicroSteps(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l0(iCounter))
                ...
                l1(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " Max. Accel")
                l1(iCounter).Layout__AboveRightControl(l0(iCounter), Me.m_txtMotor_MicroSteps(iCounter))
                Me.m_txtMotor_MaxAngularAccel(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l1(iCounter))
                ...
                l2(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " um / rev")
                l2(iCounter).Layout__AboveRightControl(l1(iCounter), Me.m_txtMotor_MaxAngularAccel(iCounter))
                Me.m_txtMotor_MicronsRev(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l2(iCounter))
                ...
                l3(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " Max RPM")
                l3(iCounter).Layout__AboveRightControl(l2(iCounter), Me.m_txtMotor_MicronsRev(iCounter))
                Me.m_txtMotor_MaxRPM(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l3(iCounter))
                ...
                l4(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " Timer (uS)")
                l4(iCounter).Layout__AboveRightControl(l3(iCounter), Me.m_txtMotor_MaxRPM(iCounter))
                Me.m_txtMotor_TimerPeriod(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l4(iCounter))
                Me.m_txtMotor_TimerPeriod(iCounter).WaterMarkText = "?"

                l5(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper(sAxis & " Update Freq")
                l5(iCounter).Layout__AboveRightControl(l4(iCounter), Me.m_txtMotor_TimerPeriod(iCounter))
                Me.m_txtMotor_UpdateFreq(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l5(iCounter))
                Me.m_txtMotor_UpdateFreq(iCounter).WaterMarkText = "?"


                'btnUpdate(iCounter) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Update", AddressOf Me.btnUpdate__MotorSettings__Click)
            ...
            Dim l100 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Rx Count")
            l100.Layout__BelowControl(Me.m_txtMotor_MicroSteps(C_NUM_MOTORS - 1))
            Me.m_txtCount = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, l100)

            Dim btnGet As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Get", AddressOf Me.btnGet__MotorSettings__Click)
