...
#Region "MEMBERS"
        ...
        Private m_txtStatusFlags(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_FaultFlags
        Private m_txtX_Raw(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16
        Private m_txtY_Raw(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16
        Private m_txtZ_Raw(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16
...
#Region "EVENTS"
        ...
        ''' <remarks></remarks>
        Public Sub InernalEvent__UDPSafe__RxPacketB(ByVal ePacketType As LAPP188__RLOOP__LIB.SIL3.SafeUDP.PacketTypes.SAFE_UDP__PACKET_T, ByVal u16PayloadLength As LAPP188__RLOOP__LIB.SIL3.Numerical.U16, ByRef u8Payload() As Byte, ByVal u16CRC As LAPP188__RLOOP__LIB.SIL3.Numerical.U16)
...
#Region "PANEL LAYOUT"
        ...
        Public Overrides Sub LayoutPanel()
            ...
            Dim btnFineX(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
            Dim btnFineY(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
            Dim btnFineZ(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
            Dim btnAuto(C_NUM_ACCELS - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper
            Dim btnRequest As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(10, 10, 100, "Request Cal", MyBase.m_pInnerPanel, AddressOf Me.btnRequestCalData__Click)
            btnRequest.ToolTip__Set("Request", "Request a calibration packet")
            Dim btnStream As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Cal Stream On", AddressOf Me.btnStreamCalData__Click)
            btnStream.Layout__RightOfControl(btnRequest)

            Dim iIndex As Integer = 0
            Dim l0 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Accel 0 Status Flags")
            l0.Layout__BelowControl(btnRequest)
            Me.m_txtStatusFlags(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_FaultFlags(100, l0)
            Dim l1 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("X Raw")
            l1.Layout__AboveRightControl(l0, Me.m_txtStatusFlags(iIndex))
            Me.m_txtX_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l1)
            btnFineX(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "X Fine Zero", AddressOf Me.btnFineX__Click)
            btnFineX(iIndex).Layout__RightOfControl(Me.m_txtX_Raw(iIndex))
            btnFineX(iIndex).Tag = iIndex.ToString
            Dim l2 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Y Raw")
            l2.Layout__AboveRightControl(l1, btnFineX(iIndex))
            Me.m_txtY_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l2)
            btnFineY(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Y Fine Zero", AddressOf Me.btnFineY__Click)
            btnFineY(iIndex).Layout__RightOfControl(Me.m_txtY_Raw(iIndex))
            btnFineY(iIndex).Tag = iIndex.ToString
            Dim l3 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Z Raw")
            l3.Layout__AboveRightControl(l2, btnFineY(iIndex))
            Me.m_txtZ_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l3)
            btnFineZ(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Z Fine Zero", AddressOf Me.btnFineZ__Click)
            btnFineZ(iIndex).Layout__RightOfControl(Me.m_txtZ_Raw(iIndex))
            btnFineZ(iIndex).Tag = iIndex.ToString
            btnAuto(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Auto Cal", AddressOf Me.btnAutoCal__Click)
            btnAuto(iIndex).Layout__RightOfControl(btnFineZ(iIndex))
            btnAuto(iIndex).Tag = iIndex.ToString

            iIndex += 1
            Dim l10 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Accel 1 Status Flags", Me.m_txtStatusFlags(iIndex - 1))
            Me.m_txtStatusFlags(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_FaultFlags(100, l10)
            Dim l11 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("X Raw")
            l11.Layout__AboveRightControl(l10, Me.m_txtStatusFlags(iIndex))
            Me.m_txtX_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l11)
            btnFineX(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "X Fine Zero", AddressOf Me.btnFineX__Click)
            btnFineX(iIndex).Layout__RightOfControl(Me.m_txtX_Raw(iIndex))
            btnFineX(iIndex).Tag = iIndex.ToString
            Dim l12 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Y Raw")
            l12.Layout__AboveRightControl(l11, btnFineX(iIndex))
            Me.m_txtY_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l12)
            btnFineY(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Y Fine Zero", AddressOf Me.btnFineY__Click)
            btnFineY(iIndex).Layout__RightOfControl(Me.m_txtY_Raw(iIndex))
            btnFineY(iIndex).Tag = iIndex.ToString
            Dim l13 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Z Raw")
            l13.Layout__AboveRightControl(l12, btnFineY(iIndex))
            Me.m_txtZ_Raw(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S16(80, l13)
            btnFineZ(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Z Fine Zero", AddressOf Me.btnFineZ__Click)
            btnFineZ(iIndex).Layout__RightOfControl(Me.m_txtZ_Raw(iIndex))
            btnFineZ(iIndex).Tag = iIndex.ToString
            btnAuto(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Auto Cal", AddressOf Me.btnAutoCal__Click)
            ...
            Dim l99 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Packet Count")
            l99.Layout__BelowControl(Me.m_txtStatusFlags(iIndex))
            Me.m_txtCount = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(100, l99)
            Dim l999 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("CRC")
            l999.Layout__AboveRightControl(l99, Me.m_txtCount)
            Me.m_txtCRC = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper(80, l999)

            Dim l100 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Full Data Streaming")
            l100.Layout__BelowControl(Me.m_txtCount)

            Dim btnRequestFull As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Request Full", AddressOf Me.btnRequestFullData__Click)
            btnRequestFull.Layout__BelowControl(l100)
            btnRequestFull.ToolTip__Set("Request", "Request a calibration packet")
            Dim btnStreamFull As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Full Stream On", AddressOf Me.btnStreamFullData__Click)
            btnStreamFull.Layout__RightOfControl(btnRequestFull)

            Dim btnDAQ As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper(100, "Enable DAQ", AddressOf Me.btnDAQ__Click)
            btnDAQ.Layout__RightOfControl(btnStreamFull)


            Dim l200(C_NUM_ACCELS - 1, 6 - 1) As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper

            iIndex = 0
            l200(iIndex, 0) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("A:" & iIndex.ToString & " Accel (mm/s^2)")
            l200(iIndex, 0).Layout__BelowControl(btnRequestFull)
            Me.m_txtCalc__CurrentAccel_mmss(iIndex) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S32(100, l200(iIndex, 0))

            l200(iIndex, 2) = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("A:" & iIndex.ToString & " Veloc (mm/s)")
            ...
            Dim l402 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Accel Thresh Accel mm ss")
            ...
            Dim l500 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Decel Thresh: True", Me.m_txtValid_Enable)
            Me.m_txtAccelThresh_True = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_U8(100, l500)

            Dim l501 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Decel Thresh x10MS")
            l501.Layout__AboveRightControl(l500, Me.m_txtAccelThresh_True)
            Me.m_txtAccelThresh_10xms = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_U16(100, l501)

            Dim l502 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Decel Thresh Accel mm ss")
            l502.Layout__AboveRightControl(l501, Me.m_txtAccelThresh_10xms)
            Me.m_txtAccelThresh_Accel_mm_ss = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_S32(100, l502)

            Dim l503 As New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.LabelHelper("Decel 10ms Counter")
            l503.Layout__AboveRightControl(l502, Me.m_txtAccelThresh_Accel_mm_ss)
            Me.m_txtAccelThresh_10ms_Counter = New LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.TextBoxHelper_U16(100, l503)
...
#Region "BUTTON HELPERS"
        ...
        Private Sub btnDAQ__Click(s As Object, e As EventArgs)
            ...
            If pSB.Text = "Enable DAQ" Then
                ...
                Me.m_pDAQ.DAQTypes__Register(0, 0, 1, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A0_X", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 2, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A0_Y", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 3, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A0_Z", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 4, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A1_X", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 5, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A1_Y", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 6, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S16, "A1_Z", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 7, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A0_ACCEL", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 8, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A0_VELOC", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 9, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A0_DISP", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 10, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A1_ACCEL", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 11, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A1_VELOC", C_ACCEL_FREQ_HZ)
                Me.m_pDAQ.DAQTypes__Register(0, 0, 12, LAPP188__RLOOP__LIB.SIL3.DAQ.Top.E_DAQ__DATA_TYPES.DATA_TYPE__S32, "A1_DISP", C_ACCEL_FREQ_HZ)
        ...
        Private Sub btnFineX__Click(s As Object, e As EventArgs)
            Dim oB As LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper = CType(s, LAPP188__RLOOP__LIB.SIL3.ApplicationSupport.ButtonHelper)
