...
*******************************************************************************/
    #define C_LOCALDEF__LCCM118__ENABLE_THIS_MODULE                         (1U)
        ...
        /** Enable 2D point math */
        #define C_LOCALDEF__LCCM118__ENABLE_POINTS                          (0U)

        /** String conversion functions. Some of these functions are not needed
        on various platforms and also rely on other math functions */
        #define C_LOCALDEF__LCCM118__ENABLE_STRINGS                         (1U)
