...
*******************************************************************************/
	#define C_LOCALDEF__LCCM231__ENABLE_THIS_MODULE							(1U)
		...
		#define C_LOCALDEF__LCCM231__M0__PIN_DIR__LATCH(x)					{if(x == 0) vRM4_MIBSPI135_PINS__Set(MIBSPI135_CHANNEL__5, MIBSPI135_PIN__CS1, 0); else vRM4_MIBSPI135_PINS__Set(MIBSPI135_CHANNEL__5, MIBSPI135_PIN__CS1, 1);}
		...
		#define C_LOCALDEF__LCCM231___MOTOR0__DEFAULT_MAX_ACCELERATION 			300
		//Value in mm / rev
		...
		#define C_LOCALDEF__LCCM231___MOTOR0__DEFAULT_MAX_ANGULAR_VELOCITY 		350


		#define C_LOCALDEF__LCCM231___MOTOR1__DEFAULT_DEFAULT_RESOLUTION        2
		//Value in rev / square second
		#define C_LOCALDEF__LCCM231___MOTOR1__DEFAULT_MAX_ACCELERATION 			300
		//Value in mm / rev
		...
		//Value in RPMs [Integer]
		#define C_LOCALDEF__LCCM231___MOTOR1__DEFAULT_MAX_ANGULAR_VELOCITY 		350
