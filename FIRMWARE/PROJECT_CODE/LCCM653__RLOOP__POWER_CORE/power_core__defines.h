...
#define RLOOP_POWER_CORE__DEFINES_H_
	...
	#define C_PWRCORE_HOVERENGINE0_N2HET_PIN_NUMBER			(8U)
	#define C_PWRCORE_HOVERENGINE1_N2HET_PIN_NUMBER			(8U)
	#define C_PWRCORE_HOVERENGINE2_N2HET_PIN_NUMBER			(16U)
	#define C_PWRCORE_HOVERENGINE3_N2HET_PIN_NUMBER			(16U)
	#define C_PWRCORE_HOVERENGINE4_N2HET_PIN_NUMBER			(22U)
	#define C_PWRCORE_HOVERENGINE5_N2HET_PIN_NUMBER			(22U)
	#define C_PWRCORE_HOVERENGINE6_N2HET_PIN_NUMBER			(23U)
	#define C_PWRCORE_HOVERENGINE7_N2HET_PIN_NUMBER			(23U)
	#define C_PWRCORE_EDDYBRAKE0_N2HET_PIN_NUMBER			(4U)
	#define C_PWRCORE_EDDYBRAKE1_N2HET_PIN_NUMBER			(4U)
