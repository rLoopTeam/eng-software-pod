...
Lfloat32 f32PWRNODE_CHG_IV__Filter_ADC_Value(Lfloat32 ADC_Sample);
...
{
	vSIL3_FAULTTREE__Init(&sPWRNODE.sHASS600.sFaultFlags);
...
void vPWRNODE_CHG_IV__Process(void)
{
	...
	if(u8New == 1U)
	{
		...
		{
			vSIL3_FAULTTREE__Set_Flag(&sPWRNODE.sHASS600.sFaultFlags, C_LCCM653__IVMEASURE__FAULT_INDEX__00);
			vSIL3_FAULTTREE__Set_Flag(&sPWRNODE.sHASS600.sFaultFlags, C_LCCM653__IVMEASURE__FAULT_INDEX_MASK__00);
		}
