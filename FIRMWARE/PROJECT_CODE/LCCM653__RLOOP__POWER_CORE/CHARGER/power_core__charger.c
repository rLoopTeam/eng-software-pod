...
void vPWRNODE_CHG__Init(void)
{
	...
	u8Test = u8SIL3_EEPARAM_CRC__Is_CRC_OK(	C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_VOLT,
	...
	else
	{
		...
		//default the data
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_VOLT, 4.1F, DELAY_T__DELAYED_WRITE);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_PACK_VOLT, 75.6F, DELAY_T__DELAYED_WRITE);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MIN_PACK_VOLT, 45.1F, DELAY_T__DELAYED_WRITE);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_TEMP, 40.0F, DELAY_T__IMMEDIATE_WRITE);
		...
		//update our CRC
		vSIL3_EEPARAM_CRC__Calculate_And_Store_CRC(	C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_VOLT,
												C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_TEMP,
												C_POWERCORE__EEPARAM_INDEX__CHARGER__CRC);
