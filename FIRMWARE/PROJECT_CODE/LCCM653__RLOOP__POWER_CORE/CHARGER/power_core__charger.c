...
void vPWRNODE_CHG__Init(void)
{
	...
	else
	{
		...
		//default the data
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_VOLT, 4.1F, 1U);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_PACK_VOLT, 75.6F, 1U);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MIN_PACK_VOLT, 45.1F, 1U);
		vSIL3_EEPARAM__WriteF32(C_POWERCORE__EEPARAM_INDEX__CHARGER__MAX_CELL_TEMP, 40.0F, C_LOCALDEF__LCCM188_IMMEDIATE_WRITE);
