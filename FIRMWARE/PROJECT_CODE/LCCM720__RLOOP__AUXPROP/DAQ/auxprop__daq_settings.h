/**
 * @file		AUXPROP__DAQ_SETTINGS.H
 * @brief		DAQ settings for APU
 * @author		Lachlan Grogan
 * @st_fileID	LCCM720R0.FILE.008
 */

//defines for setting of the DAQ

#ifndef _AUXPROP__DAQ_SETTINGS_H_
#define _AUXPROP__DAQ_SETTINGS_H_
...
#endif /* _AUXPROP__DAQ_SETTINGS_H_ */
