...
/*
VB.NET CALL
<System.Runtime.InteropServices.DllImport(C_DLL_NAME, CallingConvention:=System.Runtime.InteropServices.CallingConvention.Cdecl)> Private Shared Sub vLCCM655R0_TS_004()
End Sub
copy to localdef.h
#include <stdio.h>
...
void vLCCM655R0_TS_004_TCASE_001(void)
{
	...
	Luint32 u32Test = u32FCU_LASERCONT_TRKDB__Get_DistanceRemain_mm(eLaser);
	//todo: USER TO ADD
	if(u32Test == )
	{
