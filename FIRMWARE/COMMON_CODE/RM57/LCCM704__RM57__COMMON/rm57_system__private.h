...
/* System Register Frame 1 Definition */
	...
	*****************************************************************************/
	typedef volatile struct systemBase1
	{
		...
		Luint32 rsvd1;                  /* 0x0024 */
		Luint32 rsvd2;                  /* 0x0028 */
		Luint32 rsvd3;                  /* 0x002C */
	...
	*****************************************************************************/
	typedef volatile struct systemBase2
	{
		...
		Luint32 rsvd2[6U];      /* 0x000C */
		Luint32 ECPCNTL;        /* 0x0024 */
		Luint32 ECPCNTL1;       /* 0x0028 */
		Luint32 rsvd3[4U];      /* 0x002C */
		Luint32 CLK2CNTRL;      /* 0x003C */
		Luint32 VCLKACON1;      /* 0x0040 */
		Luint32 rsvd4[4U];      /* 0x0044 */
		Luint32 HCLKCNTL;       /* 0x0054 */
		Luint32 rsvd5[6U];      /* 0x0058 */
		Luint32 CLKSLIP;        /* 0x0070 */
		Luint32 rsvd6;          /* 0x0074 */
		Luint32 IP1ECCERREN;	   /* 0x0078 */
		Luint32 rsvd7[28U];     /* 0x007C */
