...
; Initialize CPU Registers
    ...
    .def     _rm4_system_core__InitRegisters_
    .asmfunc
    

_rm4_system_core__InitRegisters_
...
; Initialize Stack Pointers
    ...
    .def     _rm4_system_core__InitStackPointer_
    .asmfunc

_rm4_system_core__InitStackPointer_
...
; Clear ESM CCM errorss
       ...
       .def _rm4_system_core__esmCcmErrorsClear_
       .asmfunc

_rm4_system_core__esmCcmErrorsClear_
