/**
 * @file		rm4_emac__private.h
 * @brief		Private EMAC defs.
...
*
*****************************************************************************/
#define HWREG(x) (*((volatile Luint32 *)(x)))
#define HWREGH(x) (*((volatile uint16 *)(x)))
#define HWREGB(x) (*((volatile uint8 *)(x)))
#define HWREGBITW(x, b) HWREG(((Luint32)(x) & 0xF0000000U) | 0x02000000U | (((Luint32)(x) & 0x000FFFFFU) << 5U) | ((b) << 2U))
#define HWREGBITH(x, b) HWREGH(((Luint32)(x) & 0xF0000000U) | 0x02000000U | (((Luint32)(x) & 0x000FFFFFU) << 5U) | ((b) << 2U))
#define HWREGBITB(x, b) HWREGB(((Luint32)(x) & 0xF0000000U) | 0x02000000U | (((Luint32)(x) & 0x000FFFFFU) << 5U) | ((b) << 2U))
