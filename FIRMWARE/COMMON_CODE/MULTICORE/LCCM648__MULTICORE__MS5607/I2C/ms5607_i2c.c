...
Lint16 s16MS5607_I2C__RxU16(Luint8 u8DeviceAddx, E_MS5607_CMD_T eRegister, Luint16 *pu16)
{
	...
	//read two bytes
#ifndef WIN32
	s16Return = s16RM4_I2C_USER__Rx_U8Array(RM4_I2C_CH__1, u8DeviceAddx, (Luint8)eRegister, &u8Temp[0], 2U);
...
Lint16 s16MS5607_I2C__RxU24(Luint8 u8DeviceAddx, E_MS5607_CMD_T eRegister, Luint32 *pu32)
{
	...
	//read three bytes
#ifndef WIN32
	s16Return = s16RM4_I2C_USER__Rx_U8Array(RM4_I2C_CH__1, u8DeviceAddx, (Luint8)eRegister, &u8Temp[0], 3U);
